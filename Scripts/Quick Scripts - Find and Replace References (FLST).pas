...
function Initialize: integer;
	...
	begin
		...
		flstFile				:= FileByLoadOrder(StrToInt('$07'));
		flstRefsRecOrigin 		:= RecordByFormID(flstFile, $07FF149A, false);
		flstRefsRecDestination  := RecordByFormID(flstFile, $07FF149B, false);
